    ...
    <div className="min-h-screen overflow-hidden bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-24 pb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          {/* With BOM */}
          <Card
            className="rounded-xl border-2 border-amber-400 relative animate-slide-up"
          ...
          >
            ...
            <CardContent className="p-8">
              ...
              <div className="mb-6">
                <span className="text-4xl font-bold text-charcoal">$1199</span>
                <span className="text-slate-500 ml-2">per project</span>
              </div>
...
function PricingFeature({
  ...
  return (
    <li className="flex items-start gap-3">
      <CheckCircle2
        className={`w-5 h-5 flex-shrink-0 mt-0.5 ${highlight ? "text-amber-500" : "text-emerald-500"}`}
      />
      <span
        className={`text-sm ${highlight ? "text-charcoal font-medium" : "text-slate-600"}`}
      >
        {children}
      </span>
    </li>
